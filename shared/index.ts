...
export * from './component/HealthComponent.js'
export * from './component/InventoryComponent.js'
...
export * from './component/ScoreComponent.js'
...
export * from './component/TeamComponent.js'
